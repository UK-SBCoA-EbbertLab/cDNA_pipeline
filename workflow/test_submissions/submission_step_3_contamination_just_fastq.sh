...
nextflow ../main.nf --step 3 \
    --bambu_rds "./results/test_mapq0_dRNA_only_fastq_contaminant/bambu_prep/*.rds" \
    ...
    --track_reads "True" \
    --NDR "auto" \
    --multiqc_input "./results/test_mapq0_dRNA_only_fastq_contaminant/multiQC_input/**" \
    --multiqc_config "../../references/multiqc_config.yaml" \
    --out_dir "./test_mapq0_dRNA_only_fastq_contaminant/" \
    --intermediate_qc "./results/test_mapq0_dRNA_only_fastq_contaminant/intermediate_qc_reports/" \
    --is_chm13 "False" 
